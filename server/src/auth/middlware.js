...
const addDefaultAdmin = async (req, res, next) => {
    const hashedPassword = await bcrypt.hash('NobodyIsGonnaKnow!24', 10);
    await updateDefaultAdminFields('Professor Pain', { password: hashedPassword, username: 'Professor Pain', createdBy: { id: '6764d5cb8c60fe9e6ede79f5', username: 'DEFAULT' } })
    next()
}
